prediction_1 = ""
prediction_2 = ""
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/KnxjH6-8_/model.json',modelLoaded);
    ...
    if (error) {
        ...
        if(results[0].label == "Best") { document.getElementById("update_emoji").innerHTML = "&#128077;"; }
         if(results[0].label == "Victory") { document.getElementById("update_emoji").innerHTML = "&#9996;"; }
          ...
          if(results[0].label == "Worst") { document.getElementById("update_emoji").innerHTML = "&#128078;"; }
          if(results[0].label == "Swag") { document.getElementById("update_emoji").innerHTML = "&#129304;"; }
         ...
         if(results[1].label == "Victory") { document.getElementById("update_emoji2").innerHTML = "&#9996;"; }
          ...
          if(results[1].label == "Worst") { document.getElementById("update_emoji2").innerHTML = "&#128078;"; }
          if(results[1].label == "Swag") { document.getElementById("update_emoji2").innerHTML = "&#129304;"; }
